...
export default async function BloggPage() {
  ...
  const fallbackFeatured = { title: t('featuredTitle'), excerpt: t('featuredExcerpt'), date: "2025-01-15", readTime: "6 min", category: t('featuredCategory'), slug: "strategi-inte-lever" };

  const fallbackPosts = [
    { title: t('post1Title'), excerpt: t('post1Excerpt'), date: "2024-12-20", readTime: "5 min", category: t('post1Category'), slug: "lyssna-innan-du-leder" },
    { title: t('post2Title'), excerpt: t('post2Excerpt'), date: "2024-11-28", readTime: "7 min", category: t('post2Category'), slug: "digital-transformation-inte-tekniken" },
    { title: t('post3Title'), excerpt: t('post3Excerpt'), date: "2024-11-05", readTime: "8 min", category: t('post3Category'), slug: "fran-osakerhet-till-beslutskraft" },
    { title: t('post4Title'), excerpt: t('post4Excerpt'), date: "2024-10-12", readTime: "6 min", category: t('post4Category'), slug: "mata-det-som-raknas" },
    { title: t('post5Title'), excerpt: t('post5Excerpt'), date: "2024-09-18", readTime: "7 min", category: t('post5Category'), slug: "forandringsinitiativ-misslyckas" },
  ];
    ...
    <>
      ...
      <section className="pb-28 lg:pb-36 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <Link href={`/blogg/${featured.slug}`} className="block border-t border-[#0F172A]/[0.06] pt-16 lg:pt-20 group">
              <span className="font-body text-[11px] font-semibold tracking-[0.3em] uppercase text-[#0F172A]/30">{featured.category}</span>
              <h2 className="mt-4 font-display text-2xl md:text-3xl lg:text-4xl font-bold text-[#0F172A] leading-[1.12] tracking-tight max-w-3xl group-hover:text-[#0F172A]/60 transition-colors duration-300">{featured.title}</h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {posts.map((post, i) => (
            <AnimatedSection key={post.title} delay={i * 50}>
              <Link href={`/blogg/${post.slug}`} className="block py-10 lg:py-12 border-t border-[#0F172A]/[0.08] first:border-t-0 group">
